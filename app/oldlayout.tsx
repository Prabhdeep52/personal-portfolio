...
// //         {/* Welcome Message */}
// //         <div className="mb-8">
// //             <div className="text-green-400 text-xs sm:text-sm mb-4 overflow-x-auto flex justify-center">
// //             <pre className="hidden sm:block text-center mx-auto">
// //               {`
// //       ██████╗ ██████╗  █████╗ ██████╗ ██╗  ██╗██████╗ ███████╗███████╗██████╗
// //       ██╔══██╗██╔══██╗██╔══██╗██╔══██╗██║  ██║██╔══██╗██╔════╝██╔════╝██╔══██╗
// //       ██████╔╝██████╔╝███████║██████╔╝███████║██║  ██║█████╗  █████╗  ██████╔╝
...
// //       `}
// //             </pre>
// //             <div className="sm:hidden w-full flex justify-center overflow-x-auto " style={{overflow:"hidden"}}>
// //               <pre
// //               className="text-center min-w-[600px] mx-auto"
// //               style={{
